...
public class signin {
	...
	public void user_launch_the_chrome_browser() {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\H_7\\Desktop\\ca\\hybcum\\drivers\\chromedriver.exe");
	...
	public void user_enters_email_as_and_password_as(String string, String string2) throws InterruptedException {
	   s.email1().sendKeys("saisridharmamidipaka@gmail.com");
	   Thread.sleep(3000);
	   s.pwd1().sendKeys("Sridhar733@");
	}
	@And("click on signup")
